class Api::V1::ExperiencesController < ApplicationController
  ...
  def create
    student = Student.find_by(id: params[:student_id])
    @experience.new(start_time: params[:start_time], end_time: params[:end_time], job_title: params[:job_title], company: params[:company], details: params[:details], student_id: params[:student_id])
    if @experience.save
      render :show
    else
