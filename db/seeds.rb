...
Student.all.each do | student |
  5.times do
    Experience.create(start_date: Faker::Date.between(360.days.ago, Date.today), end_date: Faker::Date.birthday(18, 65), job_title: Faker::Job.title, company: Faker::Company.name , details: Faker::Company.catch_phrase, student_id: student.id)
    Education.create(start_date: Faker::Date.between(360.days.ago, Date.today), end_date: Faker::Date.birthday(18, 65), degree: Faker::Job.field , university_name: Faker::University.name, details: Faker::Company.catch_phrase, student_id: student.id)
  end
  10.times do
...
#   end
>>>>>>> 881a90a8fd2f5c106d391186fbcd0702714ff5b9
