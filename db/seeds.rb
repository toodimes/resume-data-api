50.times do 
  student = Student.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, phone: Faker::PhoneNumber.phone_number, email: Faker::Internet.email, link_in: "www.linkedin/#{Faker::Name.first_name}#{Faker::Name.last_name}", twitter: "www.twitter.com/#{Faker::Name.last_name}", personal_url: "www.#{Faker::Name.first_name}#{Faker::Name.last_name}", resume_url: "www.sharemyresume/#{Faker::Name.first_name}", github_url: "www.github/#{Faker::Name.first_name}#{Faker::Name.last_nameå}", avatar: Faker::Avatar.image, bio: Faker::HarryPotter.quote)
end
